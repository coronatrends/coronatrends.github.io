...
window.app = new Vue({
	...
	data: {
		...
		'---------------',
		'USA (38,074,886)','India (32,474,773)','Brazil (20,614,866)','Russia (6,690,633)','UK (6,555,200)','France (6,517,026)','Colombia (4,894,702)','Italy (4,494,857)','Germany (3,898,287)','Mexico (3,249,878)','Peru (2,143,691)','Netherlands (1,923,596)','Czechia (1,677,829)','Chile (1,634,774)','Canada (1,483,647)','Japan (1,344,774)','Saudi Arabia (541,994)','Denmark (339,580)','South Korea (241,439)','China (106,876)','Australia (46,725)','New Zealand (3,159)',
