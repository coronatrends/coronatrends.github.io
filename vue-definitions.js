...
window.app = new Vue({
	...
	data: {
		...
		'---------------',
		'USA (36,888,921)','India (32,250,679)','Brazil (20,378,570)','Russia (6,531,585)','France (6,366,015)','UK (6,295,613)','Colombia (4,870,922)','Italy (4,444,338)','Germany (3,831,827)','Mexico (3,108,438)','Peru (2,133,812)','Netherlands (1,904,128)','Czechia (1,676,297)','Chile (1,629,932)','Canada (1,463,603)','Japan (1,163,665)','Saudi Arabia (539,129)','Denmark (331,736)','South Korea (226,854)','China (106,608)','Australia (40,080)','New Zealand (2,926)',
